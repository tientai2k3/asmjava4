...
<div class="container">
    ...
    <br>
    <form action="/Buoi2_war_exploded/dongsp/update?ma=${qldsp.ma}" method="POST">
        <div class="mb-3">
            <label for="formGroupExampleInput" class="form-label">Mã Dòng</label>
            <input type="text" class="form-control" id="formGroupExampleInput" name="ma" readonly value="${qldsp.ma}">
            <p>${txtMa}</p>
        </div>
        <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">Tên Dòng sản phẩm</label>
            <input type="text" class="form-control" id="formGroupExampleInput2" name="ten" value="${qldsp.ten}">
            <p>${txtTen}</p>
        </div>
        <br>
        <div>
