...
<body>
<div class="container">
    <form action="/Buoi2_war_exploded/shop/storeSP?id=${ctsp.id}&idGH=${idGH}" method="POST">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="donGia" value="${ctsp.giaBan}" readonly>
                <p>${txtDonGia}</p>
            </div>
        </div>
        <div class="row">
