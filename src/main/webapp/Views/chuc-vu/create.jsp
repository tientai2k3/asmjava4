...
<body>
    <div class="container">
        ...
        <br>
        <form action="/Buoi2_war_exploded/chuc-vu/store" method="POST">
            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label">Mã chức vụ</label>
                <input type="text" class="form-control" id="formGroupExampleInput" name="ma" value="${ma}">
                <p>${txtMa}</p>
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Tên chức vụ</label>
                <input type="text" class="form-control" id="formGroupExampleInput2" name="ten" value="${ten}">
                <p>${txtTen}</p>
            </div>
            <br>
            <div>
