...
<body>
    <div class="container">
        <form action="/Buoi2_war_exploded/shop/storeGioHang" method="POST">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="${sessionScope.user.ma}" readonly>
...
<%--&lt;%&ndash;                        <option value="1">Đã Xác Nhận</option>&ndash;%&gt;--%>
<%--                    </select>--%>
<%--                </div>--%>
<%--            </div>--%>
            <br>
